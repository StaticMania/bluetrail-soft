                ...
                <div className="space-y-9">
                  <figure className="rounded-full overflow-hidden 2xl:size-[336px] size-[280px] mx-auto relative">
                    <div className="absolute h-full w-full top-0 left-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10">
                      <Link
                        href="#"
                        className="size-[74px] rounded-full flex items-center justify-center absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 z-10 overflow-hidden">
                        <ArrowRightIcon />
                      </Link>
                    </div>
                    <Image
                  ...
                  <div className="text-center">
                    <h3 className="text-secondary text-[28px] font-medium leading-[39.2px] tracking-[-0.56px]">
                      {team.name}
                    </h3>
                  </div>
                </div>
